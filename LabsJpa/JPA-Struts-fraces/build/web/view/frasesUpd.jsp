    ...
    <body>
            ...
            <fieldset>
                ...
                <table class="tabla">
                    <tr>
                        <td>Autor</td>
                        <td>
                            <s:select name="frases.idautor.idautor" 
                                      list="cboAutores"
        ...
        <div class="msg_error ui-state-highlight ui-corner-all">
            ...
            <ul> <%-- para errores por validacion --%>
                <s:if test="fieldErrors.get('frases.idautor.idautor').size() > 0">
                    <li>
                        <s:property value="fieldErrors.get('frases.idautor.idautor').get(0)" />
                    </li>
                </s:if>
